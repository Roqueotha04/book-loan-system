...
public class DataProvider {
    ...
    public static List<BookResponse> bookResponseListMock(){
        return List.of(
                new BookResponse(1L, "1984", BookGenre.FICTION, 15,true, "8789876298523",new PublisherResponse(1L, "Publisher 1"), null),
                new BookResponse(2L,"Harry Potter and the Philosopher's Stone", BookGenre.FANTASY, 20, true,"8789876298524", new PublisherResponse(2L, "Publisher 2"), null),
                new BookResponse(3L,"The Lord of the Rings", BookGenre.FANTASY, 12, true,"8789876298525", new PublisherResponse(3L, "Publisher 3"),null)
        );
    }
}
